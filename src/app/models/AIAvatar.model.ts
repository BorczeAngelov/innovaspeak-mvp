...
export function generateAvatarObjects(): AIAvatarModel[] {
    const avatarDetails = [
        ...
        { imageName: 'Innova_F_005.jpg', name: 'Noah', subtitle: 'Adventure Curator', longText: `Hi, I'm Noah, your Adventure Curator. Imagine me as your companion in discovering new experiences and challenges. Together, we'll embark on quests that test your limits, learn new skills, and explore the unknown. Whether it's virtual exploration or real-world adventures, I'm here to make each journey unforgettable. Ready for adventure? Let's set forth into the great beyond.` },
